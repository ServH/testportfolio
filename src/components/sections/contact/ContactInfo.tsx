  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start">
        ...
        <div className="ml-4">
          <h3 className="text-lg font-medium">Horario de contacto</h3>
          <p className="text-gray-600 dark:text-gray-300">
      ...
      <div className="pt-6 mt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="flex space-x-4">
          <a 
            ...
            className="p-2 bg-primary-100 dark:bg-primary-900/30 rounded-full text-primary-600 dark:text-primary-400 hover:bg-primary-200 dark:hover:bg-primary-800/50 transition-colors"
            aria-label="Twitter"
          >
